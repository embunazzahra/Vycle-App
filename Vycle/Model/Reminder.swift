...
//    var isUsingData: Bool
    ...
    init(date: Date, sparepart: Sparepart, reminderOdo: Float, kmInterval: Float, dueDate: Date, timeInterval: Int, vehicle: Vehicle, isRepeat: Bool, isDraft: Bool, service: Servis? = nil, isHelperOn: Bool, isEdited: Bool) {
        self.date = date
